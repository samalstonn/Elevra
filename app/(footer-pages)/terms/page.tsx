...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto p-4">
      ...
      <p className="mb-2">
        Welcome to Elevra. These Terms of Service (&quot;Terms&quot;) govern
        your access to and use of our website and services.
      </p>
      <h2 className="text-2xl font-semibold mt-6 mb-2">Acceptance of Terms</h2>
      <p className="mb-2">
        By accessing or using Elevra, you agree to be bound by these Terms. If
        you do not agree, please do not use our services.
      </p>
      <h2 className="text-2xl font-semibold mt-6 mb-2">Use of Service</h2>
      <p className="mb-2">
        We strive to ensure accuracy and reliability, but cannot guarantee that
