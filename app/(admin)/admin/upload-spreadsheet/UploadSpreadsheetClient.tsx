...
export default function UploadSpreadsheetClient() {
  ...
  }, [searchParams, searchParamsString, loadUploadById, activeUpload?.uploadId]);
  ...
  }, [searchParams, searchParamsString, performLookup, lookupFilename, lookupUploader]);
